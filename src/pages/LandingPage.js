      ...
      <div className='container mx-auto px-5 md:px-20 flex flex-col gap-5 justify-center py-20 md:py-0 min-h-[100vh]  '>
        ...
        <div className=' flex flex-col gap-2 text-justify '>
          <h1>
            ...
            Thrives on embracing new technologies and frameworks to stay at the
            forefront of the field. Collaborative and creative problem-solver
            committed to delivering innovative web solutions. Seeking
            opportunities to contribute to a dynamic team and make a lasting
